package com.example.common.constant.kafka;

public class Topics {

     public static final String EMAIL_REQUEST_TOPIC = "email_requests";

     public static final String USER_REQUEST_TOPIC = "user_requests";
