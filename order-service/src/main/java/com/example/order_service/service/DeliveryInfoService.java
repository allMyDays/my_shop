...
public class DeliveryInfoService {
    ...
    public void setDeliveryInfo(long userId, @NonNull String fullAddress){
        ...
        UserAddressDto newAddress = geoapifyClient.normalizeAddress(fullAddress);
        ...
        RouteResponseDto routeResponse = geoapifyClient.calculateRoute(newAddress.getLatitude(),newAddress.getLongitude(), STORAGE_LATITUDE, STORAGE_LONGITUDE);
