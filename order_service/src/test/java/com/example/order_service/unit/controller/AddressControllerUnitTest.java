...
class AddressControllerUnitTest {
    ...
    void suggest_WhenValidQuery_ShouldReturnAddressSuggestions() {
        ...
        when(daDataClient.suggestAddress(eq(query))).thenReturn(expectedSuggestions);
        ...
        verify(daDataClient).suggestAddress(query);
    }
    ...
    void suggest_WhenEmptyQuery_ShouldReturnEmptyList() {
        ...
        when(daDataClient.suggestAddress(eq(emptyQuery))).thenReturn(emptySuggestions);
        ...
        verify(daDataClient).suggestAddress(emptyQuery);
    }
    ...
    void suggest_WhenNullQuery_ShouldHandleGracefully() {
        ...
        when(daDataClient.suggestAddress(isNull())).thenReturn(emptySuggestions);
        ...
        // Assert
        assertTrue(result.isEmpty());
        verify(daDataClient).suggestAddress(null);
    }
    ...
    void suggest_WhenDaDataReturnsNull_ShouldReturnNull() {
        ...
        when(daDataClient.suggestAddress(eq(query))).thenReturn(null);
