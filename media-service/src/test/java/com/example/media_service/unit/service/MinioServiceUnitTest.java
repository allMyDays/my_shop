...
class MinioServiceUnitTest {
    ...
    @Test
    void deleteMultipleFiles_WithEmptyList_ThrowsRunTimeException() {

        assertThrows(RuntimeException.class, ()-> minioService.deleteMultipleFiles(List.of()));
    ...
    @Test
    void deleteMultipleFiles_WithMoreThan1000Files_ThrowsRunTimeException() {
        // Given
